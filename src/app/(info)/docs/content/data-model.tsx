      ...
      sections={[
        {
          ...
          content: (
            <>
              The Cytoscape Exchange (CX) format is a flexible, modular format
              for representing biological networks.
              <br />
              <br />
              CX is designed for:
...

        {
          ...
          content: (
            <>
              ...
              <br />
              <br />
              Each aspect represents a specific type of data, such as nodes,
              edges, or attributes. Applications can process only the aspects
...

        {
          ...
          note:
            'New applications should use CX2 whenever possible.',
        },
...

        {
          ...
          content: (
            <>
              For complete schema definitions, examples, and advanced aspects,
